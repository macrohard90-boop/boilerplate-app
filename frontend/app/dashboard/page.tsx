  ...
  return (
    <div>
      <h1 className="font-serif text-2xl font-bold mb-6">
        Welcome back,{" "}
        <span className="gradient-text">{user?.first_name || user?.email}</span>
      </h1>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-text-muted">
                Manage your Stripe Connect account and payouts.
              </p>
            </div>
            <Link
        ...
        <div className="glass rounded-xl p-5 mb-8 border border-accent-purple/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-text-muted">
                Upgrade to a merchant account to list products and receive
                payments.
              </p>
            </div>
            <Link
          ...
          <div className="space-y-3">
            {recentOrders.map((order) => (
              <Link
                ...
                className="flex items-center justify-between p-3 rounded-lg hover:bg-glass-hover transition-colors group"
              >
                <div>
