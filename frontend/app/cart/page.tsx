      ...
      {cart.items.length === 0 ? (
        <div className="glass rounded-2xl p-12 text-center">
          ...
          <p className="text-text-secondary mb-6">
            Discover our products and add something to your cart
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="glass rounded-2xl p-6 sticky top-24">
              ...
              <Link
                href="/products"
                className="block text-center text-sm text-text-muted hover:text-text-secondary transition-colors mt-4"
              >
                Continue Shopping
              </Link>
            </div>
    ...
    <div className="glass rounded-xl p-4 flex gap-4">
      ...
      <div className="flex flex-col items-end gap-2">
        ...
        <div className="flex items-center glass rounded-lg">
          <button
            onClick={() => handleQuantity(Math.max(1, item.quantity - 1))}
            className="px-2 py-1 text-sm text-text-secondary hover:text-text-primary"
          >
            -
          </button>
          <span className="px-2 py-1 text-sm text-text-primary min-w-[28px] text-center">
            {item.quantity}
          </span>
          <button
