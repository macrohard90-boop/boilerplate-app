  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold gradient-text">Subscriptions</h1>
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${
              statusFilter === f.value
                ...
                : "text-text-muted hover:text-text-primary border border-glass-border hover:border-glass-border-hover"
            }`}
          >
            {f.label}
          </button>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-glass-border">
                  ...
                  <th className="text-right p-4 text-text-muted font-medium">Stripe ID</th>
                </tr>
              </thead>
              <tbody>
                {data.items.map((sub) => (
