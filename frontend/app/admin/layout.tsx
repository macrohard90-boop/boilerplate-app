...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/analytics", label: "Analytics", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z", feature: "tracking" },
  { href: "/admin/marketing", label: "Marketing", icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", feature: "marketing" },
  ...
  { href: "/admin/seo", label: "Engine Optimization", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
];

export default function AdminLayout({ children }: { children: React.ReactNode }) {
  const { user, isAuthenticated, isLoading } = useAuth();
  const { enable_products, enable_subscriptions, enable_tracking, enable_marketing } = useConfig();
  ...
  const visibleNav = NAV_ITEMS.filter((item) => {
    ...
    if (item.feature === "marketing") return enable_marketing;
    return true;
  });
