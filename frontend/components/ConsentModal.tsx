...
export default function ConsentModal({ isOpen, onClose }: ConsentModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleDismiss} title="Your Privacy Preferences" size="lg">
      <p className="text-sm text-text-secondary mb-6">
        Choose how we use your data. You can change these anytime in Dashboard &gt; Privacy.
      </p>
