...
export default function CookieBanner() {
  ...
  useEffect(() => {
    ...
    const consentModalCompleted = localStorage.getItem(
      "consent_modal_completed",
    );
          ...
          <>
            <div className="flex items-start gap-4">
              <div className="flex-1">
                ...
                <p className="text-xs text-text-secondary">
                  We use cookies to enhance your experience. Some are necessary
                  for the site to work, others help us improve it.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap gap-3 mt-4">
              ...
              <button
                ...
                className="text-xs text-text-muted hover:text-text-secondary transition-colors px-4 py-2"
              >
                Customize
              </button>
            </div>
              ...
              {Object.entries(prefs).map(([key, val]) => {
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        !isNecessary && setPrefs((p) => ({ ...p, [key]: !val }))
                      }
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-4 h-4 rounded-full transition-all ${val ? "left-5 bg-accent-green" : "left-0.5 bg-text-muted"}`}
                      />
                    </button>
                  </label>
                );
