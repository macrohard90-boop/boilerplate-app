...
export const RULE_DESCRIPTIONS: Record<string, RuleDescription> = {
  ...
  title_present: {
    ...
    passingLooks: "Your page has a non-empty <title> tag in the <head> section.",
    howToFix: null,
  },
  ...
  internal_links: {
    ...
    passingLooks: "Page contains 2 or more links to other pages on the same domain.",
    howToFix:
  ...
  external_links_present: {
    ...
    passingLooks: "At least 1 outbound link to an external domain (e.g., https://example.com).",
    howToFix:
  ...
  viewport_present: {
    ...
    passingLooks: "Page has a <meta name=\"viewport\"> tag in the <head> section.",
    howToFix:
  ...
  img_dimensions: {
    ...
    passingLooks: "80% or more of images on the page have explicit width and height attributes.",
    howToFix:
