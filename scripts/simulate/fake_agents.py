...
AGENTS: list[FakeAgent] = [
    ...
    FakeAgent(
        ...
        browser="Chrome", os="Windows 10", device_type="desktop",
    ),
    FakeAgent(
    ...
    FakeAgent(
        ...
        browser="Firefox", os="Windows 10", device_type="desktop",
    ),
    FakeAgent(
    ...
    FakeAgent(
        ...
        browser="Edge", os="Windows 10", device_type="desktop",
    ),
    # ── Mobile — Chrome ──
    FakeAgent(
    ...
    FakeAgent(
        ...
        browser="Opera", os="Windows 10", device_type="desktop",
    ),
    # ── Mobile — Firefox ──
    FakeAgent(
        raw="Mozilla/5.0 (Android 14; Mobile; rv:125.0) Gecko/125.0 Firefox/125.0",
        browser="Firefox", os="Android", device_type="mobile",
    ),
